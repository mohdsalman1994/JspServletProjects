			...
			if (responseJson != null) {
				...
				$
					...
					function (key, value) {
						...
						html += "<tr><td><button type='button' class='btn btn-success'>"							
							+ bookName
							+ "</button></td><td>"
							...
							+ "<button type='button' onclick='confirmDelete(\""+bookName+"\");' class='btn  '><i class='fa fa-trash-o' aria-hidden='true'></i></button ></td></tr>";
