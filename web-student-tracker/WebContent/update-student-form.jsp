					...
					<div class="form-group">
						<div class="input-group mb-2 mr-sm-2 mb-sm-0">
							<input type="text" name="firstName" class="form-control"
								id="firstName" placeholder="Doe" value="${theStudent.firstName}"  required autofocus>
						</div>
					</div>
				</div>
				<div class="col-md-3">
					...
					<div class="form-group">
						<div class="input-group mb-2 mr-sm-2 mb-sm-0">
							<input type="text" name="lastName" class="form-control"
								id="lastName" placeholder="Doe" value="${theStudent.lastName}" required autofocus>
						</div>
					</div>
				</div>
				<div class="col-md-3">
					...
					<div class="form-group">
						<div class="input-group mb-2 mr-sm-2 mb-sm-0">
							...
							<input type="email" name="email" id="email" class="form-control"
								placeholder="Email address" value="${theStudent.email}" required autofocus>
						</div>
					</div>
				</div>
				<div class="col-md-3">
