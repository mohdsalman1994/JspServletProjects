...
public class MvcDemoServletTwo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Step 1: get the sample data from helper class(model)
		List<Student> studentsList = StudentDataUtil.getStudentsList();
		
		// Step 2: add the students list to request object
